...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p1 = new Product(null, 123, "item1", "110225", 50.50);
		Product p2 = new Product(null, 123, "item2", "110225", 100.50);
		Product p3 = new Product(null, 123, "item3", "110225", 200.50);
		
		Branch b1 = new Branch(null, 1, 123, 5, new Date(), 123, "apresentou falha");
		Branch b2 = new Branch(null, 2, 123, 5, new Date(), 345, "apresentou falha");
		Branch b3 = new Branch(null, 3, 123, 5, new Date(), 678, "apresentou falha");
		...
		o1.setPayment(pay1);
		Payment pay2 = new Payment(null, Instant.parse("2023-06-02T21:00:07Z"), o2);
		o2.setPayment(pay2);
